/*
  ...
  1. Changes
    - Drop and recreate programs table with new schema
    - Add constraints for channel and genre
    - Add timestamps and creator tracking
    - Enable RLS with proper policies

  2. Security
    - Enable RLS
    - Add policies for viewing and managing programs
*/
